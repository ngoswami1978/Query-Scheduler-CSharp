...
namespace QueryShedular_HL_HX_CODD
{
    public class ExportToExcel_WIN_App
    {
        ...
        try
        {
            System.Data.DataView view = new System.Data.DataView(objDT);
            string[] DataColumn = { "YEAR", "MONTH", "LCODE", "CHAIN_CODE", "CHAIN_NAME", "AGENCY_NAME", "OFFICEID", "CITY", "COUNTRY", "PRODUCTIVITY_CODD_PK_HX", "INTL", "TTL_HL", "HL_INTL", "S2_DOM_CODD_PK_HX", "S2_HL_NETSTATUS", "UK_DOM_CODD_PK_HX", "UK_HL_NETSTATUS", "9W_DOM_CODD_PK_HX", "9W_HL_NETSTATUS", "ROI", "AI_DOM_CODD_PK_HX", "AI_HL_NETSTATUS", "TOTALPK", "DOM_PK_UK", "DOM_PK_AI", "DOM_PK_9W", "DOM_PK_S2", "S2_HX", "UK_HX", "9W_HX", "AI_HX", "HX_BOOKINGS", "CODD" };
            DataColumn = QueryClass.lstReportColumn.ToArray();
            System.Data.DataTable selected = view.ToTable("Selected", false, DataColumn);
            objDT = selected;
            /******** Code newly implemented by [Neeraj Goswami] as on dated 09/03/2015*/
            /*- New CR*************/
            /****** The requirement is to add a new airline code “UK” in the Query Scheduler as a separate column. All the criteria’s would be same as already working for IC or I7 airline.
            ******* Also need to remove the below mentioned columns from the Query…
            ******* IC_DOM_CODD_PK_HX *******************************************************************************************************************************************************
            ******* IC_HL_NETSTATUS *********************************************************************************************************************************************************
            ******* IT_DOM_CODD_PK_HX *******************************************************************************************************************************************************
            ******* IT_HL_NETSTATUS *********************************************************************************************************************************************************
            ******* ITRED_DOM_CODD_PK_HX ****************************************************************************************************************************************************
            ******* ITRED_HL_NETSTATUS ******************************************************************************************************************************************************
            ******* I7_DOM_CODD_PK_HX *******************************************************************************************************************************************************
            ******* I7_HL_NETSTATUS *********************************************************************************************************************************************************
            ******* DOM_PK_IC ***************************************************************************************************************************************************************
            ...
            ********/
            ...
            {
                if (
                    objDT.Columns[i].ColumnName.ToString().Trim() == "IC_DOM_CODD_PK_HX" || objDT.Columns[i].ColumnName.ToString().Trim() == "IC_HL_NETSTATUS"  || objDT.Columns[i].ColumnName.ToString().Trim() == "IT_DOM_CODD_PK_HX" || objDT.Columns[i].ColumnName.ToString().Trim() == "IT_HL_NETSTATUS" || objDT.Columns[i].ColumnName.ToString().Trim() == "ITRED_DOM_CODD_PK_HX" || objDT.Columns[i].ColumnName.ToString().Trim() == "ITRED_HL_NETSTATUS" || objDT.Columns[i].ColumnName.ToString().Trim() == "I7_DOM_CODD_PK_HX" || objDT.Columns[i].ColumnName.ToString().Trim() == "I7_HL_NETSTATUS" || objDT.Columns[i].ColumnName.ToString().Trim() == "DOM_PK_IC" || objDT.Columns[i].ColumnName.ToString().Trim() == "DOM_PK_IT" ||  objDT.Columns[i].ColumnName.ToString().Trim() == "IC_HX" || objDT.Columns[i].ColumnName.ToString().Trim() == "IT_HX" || objDT.Columns[i].ColumnName.ToString().Trim() == "I7_HX" )
                {
                    objDT.Columns.Remove(objDT.Columns[i].ColumnName.ToString().Trim());
                    objDT.AcceptChanges();
                }
            }
            /******** done by neeraj as on date 09/03/2015 - New CR*************/
