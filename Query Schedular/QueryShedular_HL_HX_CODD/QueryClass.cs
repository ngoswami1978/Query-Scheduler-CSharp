...
{      
    ...
    {
        public static List<String> lstReportColumn = new List<String>();
        public static void fillReportColuimn(ListBox objlstBox)
        {
            lstReportColumn.Clear();
            foreach (string str in objlstBox.Items)
            {
                lstReportColumn.Add(str);
            }
        }
